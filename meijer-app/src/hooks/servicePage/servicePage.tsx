...
const ServicePage = (): JSX.Element => {
    ...
    return (
        <>
            <Header classNameAdded=" header--services" />
            <div className="servicePage">
                ...
                <div className="servicePage__service">
                    ...
                    <div className={`servicePage__service__border ${webEntry?.isIntersecting && freeze ? "servicePage__service__border--active" : ""}`}></div>
                </div>
                <div ref={webRef} className="servicePage__tile">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-10 -10 342 90" preserveAspectRatio="xMidYMid meet">
                ...
                <div className="servicePage__service">
                    ...
                    <div className={`servicePage__service__border ${appEntry?.isIntersecting && freeze ? "servicePage__service__border--active" : ""}`}></div>
                </div>
                <div ref={appRef} className="servicePage__tile">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-10 -10 342 90" preserveAspectRatio="xMidYMid meet">
                ...
                <div className="servicePage__service">
                    ...
                    <div className={`servicePage__service__border ${cloudEntry?.isIntersecting && freeze ? "servicePage__service__border--active" : ""}`}></div>
                </div>
                <div ref={cloudRef} className="servicePage__tile">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-10 -10 342 90" preserveAspectRatio="xMidYMid meet">
                ...
                <div ref={aiRef}  className="servicePage__contact">
                    ...
                    <Link to="/contact">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-10 -10 497 90" preserveAspectRatio="xMidYMid meet">
                            <path d="M 198.6 38 L 174.7 38 A 6.306 6.306 0 0 1 172.019 37.376 Q 170.959 36.883 169.9 36 L 167.2 33.7 A 6.53 6.53 0 0 1 166.004 32.46 A 4.606 4.606 0 0 1 165.1 29.7 L 165.1 9 Q 165.1 6 167.5 4 L 169.9 2 A 10.298 10.298 0 0 1 171.587 0.841 Q 173.144 0 174.7 0 L 201.3 0 A 6.306 6.306 0 0 1 203.981 0.624 Q 205.041 1.117 206.1 2 L 208.5 4 A 6.863 6.863 0 0 1 210.141 5.941 A 6.206 6.206 0 0 1 210.9 9 L 210.9 13 L 202.5 13 L 202.5 11.1 A 23.588 23.588 0 0 0 202.493 10.494 Q 202.472 9.669 202.387 9.287 A 1.378 1.378 0 0 0 202.35 9.15 Q 202.201 8.702 201.307 8.005 A 9.749 9.749 0 0 0 201.3 8 Q 200.608 7.461 200.152 7.248 A 1.872 1.872 0 0 0 199.9 7.15 Q 199.492 7.028 198.217 7.005 A 35.123 35.123 0 0 0 197.6 7 L 178.4 7 A 34.966 34.966 0 0 0 177.771 7.005 Q 176.506 7.028 176.1 7.15 A 1.991 1.991 0 0 0 175.797 7.273 Q 175.354 7.491 174.7 8 Q 173.808 8.694 173.653 9.142 A 0.722 0.722 0 0 0 173.65 9.15 A 1.725 1.725 0 0 0 173.592 9.397 Q 173.515 9.839 173.503 10.723 A 26.03 26.03 0 0 0 173.5 11.1 L 173.5 26.9 A 23.588 23.588 0 0 0 173.507 27.506 Q 173.528 28.331 173.613 28.713 A 1.378 1.378 0 0 0 173.65 28.85 Q 173.799 29.298 174.693 29.995 A 9.749 9.749 0 0 0 174.7 30 Q 175.392 30.539 175.848 30.752 A 1.872 1.872 0 0 0 176.1 30.85 Q 176.508 30.972 177.783 30.995 A 35.123 35.123 0 0 0 178.4 31 L 202.3 31 A 6.306 6.306 0 0 1 204.981 31.624 Q 206.041 32.117 207.1 33 L 209.5 35 A 6.863 6.863 0 0 1 211.141 36.941 A 6.206 6.206 0 0 1 211.9 40 L 211.9 61 Q 211.9 64 209.5 66 L 207.1 68 A 10.298 10.298 0 0 1 205.413 69.159 Q 203.856 70 202.3 70 L 173.7 70 A 6.306 6.306 0 0 1 171.019 69.376 Q 169.959 68.883 168.9 68 L 166.5 66 A 6.863 6.863 0 0 1 164.859 64.059 A 6.206 6.206 0 0 1 164.1 61 L 164.1 57 L 172.5 57 L 172.5 58.9 A 23.588 23.588 0 0 0 172.507 59.506 Q 172.528 60.331 172.613 60.713 A 1.378 1.378 0 0 0 172.65 60.85 Q 172.799 61.298 173.693 61.995 A 9.749 9.749 0 0 0 173.7 62 Q 174.392 62.539 174.848 62.752 A 1.872 1.872 0 0 0 175.1 62.85 Q 175.508 62.972 176.783 62.995 A 35.123 35.123 0 0 0 177.4 63 L 198.6 63 A 34.966 34.966 0 0 0 199.229 62.995 Q 200.494 62.972 200.9 62.85 A 1.991 1.991 0 0 0 201.203 62.727 Q 201.646 62.509 202.3 62 Q 203.192 61.306 203.347 60.858 A 0.722 0.722 0 0 0 203.35 60.85 A 1.725 1.725 0 0 0 203.408 60.603 Q 203.485 60.161 203.497 59.277 A 26.03 26.03 0 0 0 203.5 58.9 L 203.5 42.1 A 23.588 23.588 0 0 0 203.493 41.494 Q 203.472 40.669 203.387 40.287 A 1.378 1.378 0 0 0 203.35 40.15 Q 203.201 39.702 202.307 39.005 A 9.749 9.749 0 0 0 202.3 39 Q 201.608 38.461 201.152 38.248 A 1.872 1.872 0 0 0 200.9 38.15 Q 200.492 38.028 199.217 38.005 A 35.123 35.123 0 0 0 198.6 38 Z M 61 63 L 97.4 63 L 97.4 70 L 52.6 70 L 52.6 0 L 97.4 0 L 97.4 7 L 61 7 L 61 31 L 91.8 31 L 91.8 38 L 61 38 L 61 63 Z M 429 70 L 429 0 L 437.4 0 L 437.4 31 L 448.2 31 L 463.3 6.7 Q 464.7 4.3 466.9 2.8 L 468.8 1.5 Q 470.4 0.4 471.05 0.2 A 2.944 2.944 0 0 1 471.44 0.114 Q 472.075 0.011 473.244 0.001 A 30.189 30.189 0 0 1 473.5 0 L 475.7 0 L 475.7 3.9 A 28.401 28.401 0 0 1 475.689 4.703 Q 475.644 6.313 475.4 6.8 A 1.324 1.324 0 0 1 475.177 7.103 Q 474.678 7.634 473.3 8.4 L 472.2 9 Q 470.6 9.9 470.1 10.4 Q 469.69 10.81 468.875 12.029 A 46.062 46.062 0 0 0 468.5 12.6 L 456.5 32 A 15.577 15.577 0 0 1 455.955 32.85 Q 454.813 34.5 454 34.5 L 454 34.9 A 1.193 1.193 0 0 1 454.602 35.09 Q 455.33 35.521 456.262 36.93 A 17.1 17.1 0 0 1 456.5 37.3 L 469.2 57.4 A 27.882 27.882 0 0 0 469.644 58.131 Q 470.279 59.138 470.688 59.541 A 2.14 2.14 0 0 0 470.75 59.6 Q 471.281 60.083 472.792 60.939 A 39.273 39.273 0 0 0 472.9 61 L 474 61.6 A 18.078 18.078 0 0 1 474.622 61.961 Q 475.634 62.577 475.98 63.016 A 1.085 1.085 0 0 1 476.1 63.2 Q 476.348 63.696 476.391 65.352 A 28.875 28.875 0 0 1 476.4 66.1 L 476.4 70 L 473.6 70 Q 471.8 70 471.15 69.8 A 2.777 2.777 0 0 1 470.793 69.657 Q 470.19 69.373 469.134 68.66 A 34.351 34.351 0 0 1 468.9 68.5 L 467 67.2 Q 465.552 66.138 465.036 65.589 A 3.216 3.216 0 0 1 465 65.55 A 4.91 4.91 0 0 1 464.733 65.224 Q 464.357 64.729 463.775 63.806 A 53.037 53.037 0 0 1 463.4 63.2 L 447.8 38 L 437.4 38 L 437.4 70 L 429 70 Z M 104.3 7 L 104.3 0 L 157.1 0 L 157.1 7 L 134.9 7 L 134.9 70 L 126.5 70 L 126.5 7 L 104.3 7 Z M 243.8 7 L 243.8 0 L 296.6 0 L 296.6 7 L 274.4 7 L 274.4 70 L 266 70 L 266 7 L 243.8 7 Z M 309.5 70 L 301.1 70 L 325.1 0 L 336.9 0 L 361.4 70 L 353 70 L 347.8 55.5 L 314.5 55.5 L 309.5 70 Z M 8.4 63 L 43.2 63 L 43.2 70 L 0 70 L 0 0 L 8.4 0 L 8.4 63 Z M 384.8 63 L 419.6 63 L 419.6 70 L 376.4 70 L 376.4 0 L 384.8 0 L 384.8 63 Z M 331.2 6 L 330.8 6 A 5.238 5.238 0 0 1 330.702 6.97 Q 330.538 7.838 330.1 8.9 L 316.6 49 L 345.7 49 L 331.9 8.9 A 12.061 12.061 0 0 1 331.509 7.814 Q 331.345 7.276 331.268 6.799 A 5.028 5.028 0 0 1 331.2 6 Z" />
                        </svg>
                    </Link>
                </div>
            </div>

...
import ServiceItem2 from '../serviceItem2/serviceItem2';
    ...
    return (
        <>
            ...
            <div className="scene3">
                    <ServiceItem2 classNameAdded="" tile={
                        <>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-10 -10 342 90" preserveAspectRatio="xMidYMid meet">
                                ...
                                <g fill="url(#webPattern)">
                                    <rect className="scene3__tile" x="48" y="-10" width="226" height="46" />
                        ...
                        title={
                            <>Do you need help with building your website?</>
                        }
                        text={
                            <>We can build your website using technologies such as PHP or React.</>
                        } />
                    <ServiceItem2 classNameAdded="" tile={
                        <>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-10 -10 342 90" preserveAspectRatio="xMidYMid meet">
                                ...
                                <g fill="url(#appPattern)">
                                    <rect className="scene3__tile" x="58" y="-10" width="206" height="31" />
                        ...
                        title={
                            <>App development</>}
                        text={
                            <>Is a hybrid solution better then a native solution for your organisation?<br />We can help you with building an App suited for your goals.</>} />
                    <ServiceItem2 classNameAdded="" tile={
                        <>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-10 -10 342 90" preserveAspectRatio="xMidYMid meet">
                                ...
                                <g fill="url(#cloudPattern)">
                                    <rect className="scene3__tile" x="-10" y="-10" width="342" height="46" />
                        ...
                        title={
                            <>Fascinated about the Cloud?</>}
                        text={
                            <>We are fascinated about the Cloud and it's possibilities. Helping organisations to make use of this potential is what we want to do.</>} />
                    <ServiceItem2 classNameAdded="" tile={
                        <>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-10 -10 342 90" preserveAspectRatio="xMidYMid meet">
                                ...
                                <g fill="url(#aiPattern)">
                                    <rect className="scene3__tile" x="109" y="-10" width="104" height="46" />
                        ...
                        text={
                            <>We help organisations use the full potential of all it's data by using AI. Is your organisation ready for it?</>} />
            </div>
